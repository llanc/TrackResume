    ...
    body: `
      <section class="viewer-shell">
        ...
        ${
          input.hasResume
            ? `
              <section class="viewer-stage" data-pdf-stage>
